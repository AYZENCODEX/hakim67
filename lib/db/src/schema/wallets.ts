...
export const walletsTable = pgTable("wallets", {
  ...
  // Wallet↔Finance bridge — when true (default), confirmed deposits into and
  // withdrawals out of this wallet auto-post as Finance ledger entries
  // (+ double-entry journal lines). Per-wallet so a user can exclude e.g. a
  // hot trading wallet from their personal accounting.
  autoFinanceSync: boolean("auto_finance_sync").notNull().default(true),
